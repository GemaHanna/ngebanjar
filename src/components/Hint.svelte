<script>
	...
	const tips = [
		...
		},
		{
			...
			content:
				'Perbanyak praktik dengan berbicara bahasa Banjar, jangan lupa perbanyak kosakata juga ya',
		},
		{
			title: '[Tips] Buka Kamus',
			content:
				'Ngebanjar juga menyediakan kamus Banjar-Indonesia, kalau kamu klik kata yang bercetak tebal (kata dalam bahasa Banjar) maka kamu dapat mendengarkan cara pengucapannya',
		},
	]
